...
module.exports.config = {
	...
	description: "Đặt lịch để anya báo về thông báo", // Thông tin chi tiết về lệnh
	commandCategory: "Dành cho thành viên", // Thuộc vào nhóm nào: system, other, game-sp, game-mp, random-img, edit-img, media, economy, ...
	usages: "[text] | [ngày/tháng/năm]_[H:P:S]", // Cách sử dụng lệnh
