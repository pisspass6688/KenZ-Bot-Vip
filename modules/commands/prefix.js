module.exports.config = {
  ...
  description: "Thay đổi dấu lệnh KenZ trên nhóm", 
  commandCategory: "Dành cho qtv box",
  usages: "Gõ /prefix + dấu lệnh muốn đổi | Ví dụ /prefix 1",
  cooldowns: 0
};
...
module.exports.handleEvent = async function ({ api, event, Threads }) {
  ...
  if (body.toLowerCase() == "prefix") {
       return api.sendMessage(`${random(icon)} dấu lệnh bot nè: ${prefix}`, threadID, messageID)
  }
 }
