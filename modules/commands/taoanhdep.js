...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
  ...
  if (!fs.existsSync(__dirname + `/tad/SteelfishRg-Regular.otf`)) {
    let getfont4 = (await axios.get(`https://drive.google.com/u/0/uc?id=bc1qqxvrnh2xtsqmrvd7wg0msg8mt5ysr932w3qs8c&export=download`, { responseType: "arraybuffer" })).data;
