...
module.exports.config = {
    ...
    usages: "[shop/info/chiatay/diemdanh/top/house/pet]",
    cooldowns: 0
};
...
module.exports.run = async function ({ api, event, args, Users, Currencies }) {
    ...
    switch (input) {
        ...
        default:
            return api.sendMessage(`=====『 𝐇𝐔̛𝐎̛́𝐍𝐆 𝐃𝐀̂̃𝐍 𝐒𝐔̛̉ 𝐃𝐔̣𝐍𝐆 』=====\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n-ghép nam/nữ → tìm đối tượng để bắt đầu hẹn hò\n-ghép info → xem thông tin hẹn hò của bạn\n-ghép chiatay → chia tay chứ không chia chân\n-ghép shop → mua hoa tặng bồ\n-ghép pet → nuôi pet\n-ghép exchange → chuyển exp sang money\n-ghép top → xem top các cặp đôi trên hệ thống`, threadID, messageID);
    }
...
module.exports.handleReaction = async function ({ api, event, Threads, Users, Currencies, handleReaction }) {
    ...
    switch (type) {
        case '1': {
            ...
            var msg = {
                body: `[💏] ${author.name} - 𝐍𝐠𝐮̛𝐨̛̀𝐢 𝐦𝐚̀ 𝐡𝐞̣̂ 𝐭𝐡𝐨̂́𝐧𝐠 𝐜𝐡𝐨̣𝐧 𝐜𝐡𝐨 𝐛𝐚̣𝐧 𝐥𝐚̀: ${random.name}\n[💌] 𝐏𝐡𝐮̀ 𝐇𝐨̛̣𝐩: ${Math.floor(Math.random() * (80 - 30) + 30)}%\n\n𝐍𝐞̂́𝐮 𝐜𝐚̉ 𝟐 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐜𝐡𝐚̂́𝐩 𝐧𝐡𝐚̣̂𝐧 𝐬𝐞𝐭𝐥𝐨𝐯𝐞, 𝐡𝐚̃𝐲 𝐜𝐮̀𝐧𝐠 𝐧𝐡𝐚𝐮 𝐭𝐡𝐚̉ 𝐜𝐚̉𝐦 𝐱𝐮́𝐜 𝐭𝐫𝐚́𝐢 𝐭𝐢𝐦 [❤] 𝐯𝐚̀𝐨 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 𝐯𝐚̀ 𝐜𝐡𝐢́𝐧𝐡 𝐭𝐡𝐮̛́𝐜 𝐭𝐫𝐚̣𝐧𝐠 𝐭𝐡𝐚́𝐢 𝐬𝐞𝐭𝐥𝐨𝐯𝐞 𝐯𝐨̛́𝐢 𝐧𝐡𝐚𝐮`,
