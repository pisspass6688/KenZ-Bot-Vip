...
module.exports.handleReply = async ({ event, api, handleReply, Threads }) => {
  //const permission = ["100035018569417","100066990987283"];
    //if (!permission.includes(event.senderID)) return api.sendMessage("Bạn không có quyền tham gia vào nhóm đâu", event.threadID, event.messageID);
