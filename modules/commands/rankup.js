...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
  ...
  var id1 = event.senderID;
   ...
   var background = [
     "https://i.imgur.com/UK0DnyL.jpg",
     "https://i.imgur.com/wHyiHrl.jpg"
   ];
  ...
  fs.writeFileSync(pathImg, Buffer.from(getbackground, "utf-8"));
    ...
    ctx.drawImage(baseAvt1, 65.3, 248, 260, 260);
    ...
    fs.removeSync(pathAvt1);
		...
		await new Promise(a => setTimeout(a, 10000*10));
...
module.exports.languages = {
	"vi": {
		...
		"levelup": "Bạn {name} đã lên cấp độ {level}, Chúc bạn {name} giữ vững phong độ đó"
	},
	"en": {
		"on": "on",
		"off": "off",
