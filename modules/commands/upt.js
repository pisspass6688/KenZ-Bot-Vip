...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("BB Bot", canvas.width / 2 - 700, 1050);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("Trà Mi", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("BB Bot", 1600, 3150);
    ctx.fillStyle = "#000"
    ctx.fillText("Bot Trà Mi", 2000, 3600);
    ctx.beginPath();
