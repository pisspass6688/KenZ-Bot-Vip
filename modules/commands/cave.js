...
var a = Math.floor(Math.random() * 60000) + 10; 
var b = Math.floor(Math.random() * 60000) + 10; 
var c = Math.floor(Math.random() * 60000) + 10; 
var x = Math.floor(Math.random() * 60000) + 10; 
var y = Math.floor(Math.random() * 60000) + 10; 
var f = Math.floor(Math.random() * 60000) + 10; 
...
           
            switch(e.body) {
                case "1": msg = `🇻🇳 Bạn vừa làm cave ở Việt Nam và được ${a} VND`;
                await Currencies.increaseMoney(e.senderID, parseInt(a)); 
                break;             
                case "2": msg = `🇨🇳 Bạn vừa làm cave ở Trung Quốc và được ${b} VND`; 
                await Currencies.increaseMoney(e.senderID, parseInt(b)); 
                break;
                case "3": msg = `🇯🇵  Bạn vừa làm cave ở Nhật Bản và được ${c} VND`;
                await Currencies.increaseMoney(e.senderID, parseInt(c)); 
                break;
                case "4": msg = `🇹🇭 Bạn vừa làm cave ở Thái Lan và được ${x} VND`; 
                await Currencies.increaseMoney(e.senderID, parseInt(x)); 
                break;
                case "5": msg = `🇺🇸 Bạn vừa làm cave ở Mỹ và được ${y} VND`; 
                await Currencies.increaseMoney(e.senderID, parseInt(y)); 
                break;
                case "6": msg = `🇰🇭 Bạn vừa làm cave ở Campuchia và được ${f} VND`; 
